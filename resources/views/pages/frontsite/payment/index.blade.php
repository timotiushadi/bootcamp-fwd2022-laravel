        ...
        <div class="lg:col-span-7 lg:pl-8 lg:pr-20">
          ...
          <div class="flex flex-wrap items-center space-x-5">
            <div class="flex-shrink-0">
              <img
                src="{{ asset('/assets/frontsite/image/doctor-1.png') }}"
          ...
          <form action="" x-data="{ payment: '' }" class="mt-8">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-2 gap-5">
              <div class="relative">
                ...
                >
                  <img
                    src="{{ asset('/assets/frontsite/image/master-card.png') }}"
              ...
              <div class="relative">
                ...
                >
                  <img
                    src="{{ asset('/assets/frontsite/image/visa.png') }}"
                    class="max-h-[50px] inline-block"
                    alt="Master card"
                  />
                </label>
              ...
              <div class="relative">
                ...
                >
                  <img
                    src="{{ asset('/assets/frontsite/image/cirrus.png') }}"
                    class="max-h-[50px] inline-block"
                    alt="Master card"
                  />
                </label>
              ...
              <div class="relative">
                ...
                >
                  <img
                    src="{{ asset('/assets/frontsite/image/mewallet.png') }}"
                    class="max-h-[50px] inline-block"
                    alt="Master card"
                  />
